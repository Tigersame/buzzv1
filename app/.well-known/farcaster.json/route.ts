export async function GET() {
  ...
  const manifest = {
    ...
    miniapp: {
      ...
      subtitle: "Onchain Reputation Layer",
      description: "Measure and verify your influence onchain with BaseBuzz.",
      screenshotUrls: [],
      primaryCategory: "social",
      tags: ["reputation", "base", "social"],
      heroImageUrl: `${appUrl}/hero.png`,
      tagline: "Verify your onchain influence",
      ogTitle: "BaseBuzz",
      ogDescription: "Onchain Reputation Layer for Base",
